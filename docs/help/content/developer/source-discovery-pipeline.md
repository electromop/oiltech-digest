...
До загрузки сайта агент дополнительно отсекает явно устаревшую выдачу:

- год в URL старше допустимого порога;
- в заголовке или описании поисковой выдачи есть только старые годы;
- ссылка ведет в архив и не содержит признаков свежих материалов.

Пороги:

| Переменная | По умолчанию | Что делает |
|---|---:|---|
| `SOURCE_DISCOVERY_STALE_RESULT_YEAR_GRACE` | `1` | сколько лет поисковой выдаче можно простить |
| `SOURCE_DISCOVERY_FRESHNESS_DAYS` | `180` | максимальный возраст статей при пробном парсинге нового источника |
